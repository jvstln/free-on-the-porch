...
export type Async{{FeatureName}
}ModuleOptions = AsyncFeatureModuleOptions<
{
	FeatureName;
}
FeatureOptions>;
...
{
	static
	forRootAsync(options: Async{{FeatureName}}ModuleOptions)
	: DynamicModule
	return {
      global: true,
      module: {{FeatureName}}
	...
	Controller;
      ...
      providers: [
	provide: FEATURE_OPTIONS, useFactory
	: options.useFactory,
