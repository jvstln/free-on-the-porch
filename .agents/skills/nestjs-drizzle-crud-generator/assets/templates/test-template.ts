...
=
{
	id: "123e4567-e89b-12d3-a456-426614174000", { {MockFields };
}
...
beforeEach(async () =>
{
	...
	service = module.get < { {FeatureName };
}
Service>({{FeatureName}
}Service)
})
...
it("should throw NotFoundException for non-existent id", async () => {
	...
	await expect(service.update("non-existent-id", {} as any)).rejects.toThrow(
		"not found",
	);
});
})
